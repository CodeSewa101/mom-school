        ...
        <div className="mt-8 bg-blue-50 rounded-lg p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-blue-800">
            <div>
              ...
              <p>Account Name: School of Excellence</p>
            ...
            <div>
              ...
              <p>UPI ID: school.excellence@oksbi</p>
              <p>QR Code: Available at school office</p>
              <br />
              <p className="font-medium">Cash Payment:</p>
              <p>School Office: 9:00 AM - 4:00 PM</p>
            </div>
          </div>
          <div className="mt-4 p-4 bg-white rounded-lg">
            <p className="text-sm text-gray-600">
              <strong>Note:</strong> After making payment, please submit the
              receipt to the school office or upload it through the parent
