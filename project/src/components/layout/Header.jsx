...
export default function Header() {
  ...
  // Dynamic text size for school name
        ...
        >
          ...
          <Link to="/" className="flex items-center flex-shrink-0 min-w-0">
            ...
            >
              ...
              {/* School name - responsive visibility */}
              <div
                className={`${
              ...
              >
                <motion.h1
                  className={`font-bold ${getSchoolNameSize()} tracking-tight truncate`}
                >
                  <span className="block bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
                    {screenSize === "sm"
                      ? "MOM SCHOOL"
          ...
          <nav className="hidden lg:flex items-center space-x-1 xl:space-x-2">
                ...
                {item.name === "Academic" ? (
                  ...
                  >
                    ...
                    >
                      ...
                      />
                      {isAcademicActive() && (
                        <span className="absolute bottom-0 left-2 xl:left-3 right-2 xl:right-3 h-0.5 bg-blue-600"></span>
                      )}
                    </div>
            ...
            {currentUser ? (
              ...
              >
                <Link
                  to="/login"
                  className="inline-flex items-center px-3 xl:px-4 py-2 rounded-lg text-sm font-medium text-white bg-gradient-to-r from-blue-600 to-blue-500 shadow-sm hover:shadow-md transition-all"
                >
                  <span className="mr-2">🔑</span>
              ...
              >
                ...
                {currentUser ? (
                  ...
                  <div className="pt-2 mt-2 border-t border-gray-200/30">
                    <Link
                      to="/login"
                      className="block text-center px-4 py-2.5 rounded-md bg-blue-600 text-white font-medium hover:bg-blue-700 transition-all text-sm touch-manipulation"
                      onClick={() => setIsMenuOpen(false)}
                    >
                      Admin Login
                    </Link>
