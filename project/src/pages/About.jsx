            ...
            >
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start">
                  ...
                  <p className="ml-3 text-gray-600">Personalized learning experiences tailored to each student</p>
                </div>
                <div className="flex items-start">
                  <div className="flex-shrink-0 mt-1">
                    <div className="w-2 h-2 bg-indigo-600 rounded-full"></div>
                  </div>
                  <p className="ml-3 text-gray-600">Innovative teaching methods with cutting-edge technology</p>
                </div>
                <div className="flex items-start">
                  <div className="flex-shrink-0 mt-1">
                    <div className="w-2 h-2 bg-indigo-600 rounded-full"></div>
                  </div>
                  <p className="ml-3 text-gray-600">Supportive community fostering growth and development</p>
                </div>
              </div>
              ...
              <div className="relative rounded-3xl overflow-hidden shadow-2xl border-8 border-white">
                ...
                <div className="absolute bottom-0 left-0 p-6 text-white">
                  <div className="bg-white/20 backdrop-blur-md rounded-lg p-4 inline-block">
                    <h3 className="text-xl font-bold">Our Students in Action</h3>
                    <p className="text-sm opacity-90">Interactive learning environment</p>
                  </div>
                </div>
              </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-gray-50 to-indigo-50">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4 mt-2">Core Values</h2>
            ...
            {values.map((value, index) => (
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-3 group-hover:text-indigo-700 transition-colors duration-300">{value.title}</h3>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-8 border-white rotate-1">
                ...
                <div className="absolute bottom-0 left-0 p-6 text-white">
                  ...
                  <p className="text-sm opacity-90">Founded in 2010 with a vision for excellence</p>
                </div>
              </div>
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6 mt-2">Our Story</h2>
              ...
              <div className="space-y-6 mb-8">
                <div className="relative pl-8 pb-8 border-l-2 border-indigo-200">
                  ...
                  <h4 className="text-lg font-bold text-gray-900">2010 - Foundation</h4>
                  <p className="text-gray-600">The Pranab Educational Society was established as an independent unit with an objective of imparting skill development & stress free environment.</p>
                </div>
                <div className="relative pl-8 pb-8 border-l-2 border-indigo-200">
                  <div className="absolute left-0 top-0 w-4 h-4 rounded-full bg-indigo-600 -translate-x-1/2"></div>
                  <h4 className="text-lg font-bold text-gray-900">2012 - First Campus</h4>
                  <p className="text-gray-600">Established "MOM SCHOOL OF EXCELLENCY" at Aska as a Co-Ed school offering better education up to Standard VIII.</p>
                </div>
                <div className="relative pl-8 border-l-2 border-indigo-200">
                  <div className="absolute left-0 top-0 w-4 h-4 rounded-full bg-indigo-600 -translate-x-1/2"></div>
                  <h4 className="text-lg font-bold text-gray-900">Present Day</h4>
                  <p className="text-gray-600">Now serving 500+ students with 50+ educators across multiple programs, continuing our mission of excellence.</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {[
                  ...
                  >
                    <div className={`text-3xl font-bold text-${stat.color}-600`}>{stat.number}</div>
