          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-600 mb-6">
                At MOM SCHOOL OF EXCELLENCY, we are dedicated to providing
            ...
            >
              ...
              <div className="space-y-6 mb-8">
                ...
                <div className="relative pl-8 pb-8 border-l-2 border-indigo-200">
                  ...
                  <p className="text-gray-600">
                    Established "MOM SCHOOL OF EXCELLENCY" at Aska as a Co-Ed
                    school offering better education up to Standard VIII.
                  </p>
                </div>
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          >
            ...
            <p className="text-xl opacity-90 max-w-3xl mx-auto mb-8 text-white/90">
              Discover how MOM SCHOOL OF EXCELLENCY can help your child reach
