...
export default function PhotoGallery() {
  ...
  const filterPhotos = () => {
    if (selectedAlbum === "all") {
      ...
      const filtered = photos.filter(
        (photo) => photo.albumId === selectedAlbum
      );
  ...
  const handleDeleteAlbum = async (albumId) => {
    ...
    try {
      ...
      const deletePromises = albumPhotos.map((photo) =>
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-gray-600 mt-2">
              Manage school photos and albums
            </p>
          </div>
              ...
              return (
                ...
                >
                  <div className="relative h-48">
                    {validateImageUrl(album.coverImage) ? (
                      <img
              ...
              {filteredPhotos.map((photo) => (
                <div key={photo.id} className="relative group">
                  <div className="aspect-square bg-gray-200 rounded-lg overflow-hidden">
                    {validateImageUrl(photo.imageUrl) ? (
                      <img
                        src={photo.imageUrl}
                        ...
                        onError={(e) => {
                          ...
                          e.target.onerror = null;
                          e.target.src =
                            "https://via.placeholder.com/300?text=Photo";
                          e.target.className =
                            "w-full h-full object-cover bg-gray-200";
                        }}
                      />
                ...
                <form onSubmit={handlePhotoSubmit} className="space-y-6">
                  ...
                  <div className="flex justify-end space-x-4">
                    ...
                    <button
                      type="submit"
                      disabled={
                        !photoFormData.imageUrl || !photoFormData.albumId
                      }
        ...
        {showImageModal && selectedImage && (
          <div className="fixed inset-0 bg-black bg-opacity-90 flex items-center justify-center z-50 p-4">
            <div className="relative max-w-4xl max-h-full">
              ...
              {validateImageUrl(selectedImage.imageUrl) ? (
                <img
                  src={selectedImage.imageUrl}
                  alt={selectedImage.title || "School photo"}
