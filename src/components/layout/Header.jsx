        ...
        <div className="flex justify-between items-center h-16">
          ...
          <nav className="hidden md:flex items-center space-x-1">
            ...
            {currentUser ? (
              <div className="relative ml-4">
                ...
                >
                  <span className="relative z-10 flex items-center text-gray-800">
                    ...
                    <DropdownIcon isOpen={isUserDropdownOpen} />
                  </span>
                </motion.button>
              ...
              // Login buttons for both admin and student when not logged in
              <div className="ml-4 flex space-x-2">
                ...
                >
                  <Link
                    ...
                    className="inline-flex items-center px-4 py-2 rounded-lg text-sm font-medium text-white bg-gradient-to-r from-green-600 to-green-500 shadow-sm hover:shadow-md transition-all"
                  >
                ...
                {currentUser ? (
                  <>
                    <div className="pt-2 mt-2 border-t border-gray-200/30">
                      ...
                      <div className="px-4 py-1.5 text-xs text-blue-600 font-medium">
                        ({userRole === "admin" ? "Admin" : "Student"})
                      </div>
                      <button
                        onClick={() => {
                  ...
                  <div className="pt-2 mt-2 border-t border-gray-200/30 space-y-2">
                    <Link
                      to="/login?type=student"
                      className="block text-center px-4 py-2.5 rounded-md bg-green-600 text-white font-medium hover:bg-green-700 transition-all text-sm"
                      onClick={() => setIsMenuOpen(false)}
                    >
                      Student Login
                    </Link>
